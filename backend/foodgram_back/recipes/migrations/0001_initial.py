    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingridients', models.ManyToManyField(through='recipes.AmountIngridients', to='recipes.Ingridient')),
                ('tags', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recipes', to='recipes.tag')),
            ],
            options={
                'verbose_name': 'Рецепт',
